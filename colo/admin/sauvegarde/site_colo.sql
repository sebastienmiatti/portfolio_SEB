...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 22 Décembre 2017 à 15:32
...
(15, 'julien', 'julien@gmail.com', 'fou', 'mdr');
...
(1, 'Découverte', 'Site front ', '08/2017', '1er réalisation en formation avec Webforce3 ', 'site_front1.png', 1),
(2, 'Personnel', 'Site front', '09/2017', '1ère réalisation d''un site cv ', 'site_front2.png', 1),
(3, 'Annonceo (boutique)', 'Site back', '10/2017', '1er réalisation en formation avec Webforce3 ', 'site_back2.png', 1),
(4, 'Perso', 'Site back', '11/2017', '2eme Réalisation personnel d''un site cv ', 'site_back3.png', 1),
(5, 'Perso', 'Site front', '12/2017', '2eme réalisation pesonnel d''un site cv ', 'site_back4.png', 1);
...
(10, 'Bonjour', 'Voici le meilleur ', 'blablabla', 1);
...
(6, 'Développeur Intégrateur Web', 'Bienvenu mon site cv, réalisé en production avec lePoles, je vous tiendrais informer ici de mes inspirations, réalisations a venir ou en cours', 'logo.png', 1),
(7, 'Développeur Intégrateur Web', 'Bienvenu mon site cv, réalisé en production avec lePoles, je vous tiendrais informer ici de mes inspirations, réalisations a venir ou en cours', 'logo.png', 1),
(8, 'Développeur Intégrateur Web', 'Bienvenu mon site cv, réalisé en production avec lePoles, je vous tiendrais informer ici de mes inspirations, réalisations a venir ou en cours', 'logo1.png', 1),
(9, 'Développeur Intégrateur Web', 'Bienvenu mon site cv, réalisé en production avec lePoles, je vous tiendrais informer ici de mes inspirations, réalisations a venir ou en cours', 'logo1.png', 1),
(10, 'Développeur Intégrateur Web1', 'Bienvenu mon site cv, réalisé en production avec lePoles, je vous tiendrais informer ici de mes inspirations, réalisations a venir ou en cours', 'logo1.png', 1),
(11, 'Développeur Intégrateur Web', 'Bienvenu mon site cv, réalisé en production avec lePoles, je vous tiendrais informer ici de mes inspirations, réalisations a venir ou en cours', 'logo1.png', 1),
(12, 'Développeur Intégrateur Web', 'Bienvenu mon site cv, réalisé en production avec lePoles, je vous tiendrais informer ici de mes inspirations, réalisations a venir ou en cours', 'logo.png', 1),
(13, 'Développeur Intégrateur Web', 'Bienvenu mon site cv, réalisé en production avec lePoles, je vous tiendrais informer ici de mes inspirations, réalisations a venir ou en cours', 'logo.png', 1),
(14, 'Développeur Intégrateur Web', 'Bienvenu mon site cv, réalisé en production avec lePoles, je vous tiendrais informer ici de mes inspirations, réalisations a venir ou en cours', 'logo1.png', 1),
...
(20, 'Administrateur web', 'Bienvenu sur mon site cv, réalisé par Miatti Sébastien, je vais vous exposer ici mon parcours, et les projets qui m''entourent ', 'SebLogo.png', 1);
...
(1, 'Kevin', 'Henry', 'henry.kvin@gmail.com', 0619270798, '123456', 'Kevin Henry', 'logo1.png', 28, '1989-11-21', 'H', 'M.', '4, rue de', 95380, 'Louvres', 'France', 'https://KevinHenry.fr');
...
--
ALTER TABLE `t_commentaires`
  MODIFY `id_commentaire` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `t_textes`
  MODIFY `id_texte` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT pour la table `t_titre_cv`
--
ALTER TABLE `t_titre_cv`
  MODIFY `id_titre_cv` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
