...
// on créé et initialise une variable de succès
$success = '';
                                    ...
                                    <div class="col-md-4">
                                        <div class="jumbotron single_service  wow fadeInLeft">
                                            ...
                                            <div class="s_service_text text-sm-center text-xs-center">
                                                ...
                                                <p><?= $ligne_formation['f_soustitre'];?></p>
                                            ...
                                            <form action="#" id="feedbackForm" class="text-center" method="POST">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-md-push-3">
                                                        <button type="submit" id="feedbackSubmit" class="btn btn-alert btn-lg btn-center" style="margin-top:40px;">Envoyer</button>
                                                    </div>
                                                    <?= $success ?>
                                                </form>
                                                <!-- END CONTACT FORM -->
